## Easy PID Motor Controller (EPMC) Cpp Library (arm64-build) i.e PC
...
**Raspberry Pi, e.t.c (ARM64)**
```shell
wget https://github.com/robocre8/epmc_serial_cpp/releases/download/v1.3.1/epmc-serial-dev_1.3.1_arm64.deb
```
```shell
sudo apt install ./epmc-serial-dev_1.3.1_arm64.deb
```
